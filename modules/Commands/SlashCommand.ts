import { ChatInputApplicationCommandData, ApplicationCommand, ApplicationCommandData, Formatters, Interaction, Permissions, CommandInteraction } from 'discord.js';
import type { Command as ICommand, SlashCommand as ISC, SlashCommandPayload } from '../../shared/types/Command';
